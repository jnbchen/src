...
class can_visualizer(object):
    def __init__(self):
        ...
        self.point_ = Marker()
        self.point_.action = visualization_msgs::Marker::ADD
        self.point_.type = visualization_msgs::Marker::POINTS
        self.point_.scale.z = 0.1
        self.point_.pose.orientation.w = 1.0
        self.point_.lifetime = line_strip_.lifetime = ros::Duration(0.2)
    ...
    def callback(self, msg):
        ...
        for i in len(msg.radar_array):
            ...
            #self.marker_array_.markers.appends(self.marker_)
            self.marker_array_.markers.appends(self.point_)
        
        self.marker_array_.header.stamp = rospy.get_rostime()
        self.marker_array_.header.frame_id = 'radar'  
